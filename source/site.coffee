...
Menu = require './preact-menu.coffee'
	...
	render: ->
		h 'div',
			...
			h 'div',
				...
				h 'a',
					href: "https://github.com/arxii/preact-menu"
				...
				# 				'npm i preact preact-menu'
				# 	h Menu,
				# 		className: 'center'
				# 		h 'div',
				# 			className: 'title-snippet-text'
				# 			"var Menu = require('preact-menu')"
				h 'a',
					href: "https://github.com/arxii/preact-menu"
			...
			h 'div',
				...
				h 'p',
					...
					h 'div',
						className: 'shields'
						h 'a',
							href:'https://npmjs.com/package/preact-menu'
							h 'img',
...
EXAMPLES = [
	# ['Layout',require('./examples/layout.md'),LayoutExample,'https://github.com/arxii/preact-menu/blob/master/source/examples/LayoutExample.coffee?ts=4']
	# ['Simple Menu',require('./examples/simple-menu.md'),SimpleMenuExample,'https://github.com/arxii/preact-menu/blob/master/source/examples/SimpleMenuExample.coffee?ts=4'],
	# ['Buttons',require('./examples/buttons.md'),ButtonsExample,'https://github.com/arxii/preact-menu/blob/master/source/examples/ButtonsExample.coffee?ts=4'],
	# ['Carousel',require('./examples/carousel.md'),CarouselExample,'https://github.com/arxii/preact-menu/blob/master/source/examples/CarouselExample.coffee?ts=4'],
]
